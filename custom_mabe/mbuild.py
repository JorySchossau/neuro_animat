...
if args.debugOptimization:
    compFlags='-Wno-c++98-compat -w -Wall -std=c++17 -I../pprint/include -g -O0 -lpthread -pthread -larmadillo'
else:
    compFlags='-Wno-c++98-compat -w -Wall -std=c++17 -I../pprint/include -DNO_BOUNDS_CHECKING -march=native -ffast-math -O3 -lpthread -pthread -larmadillo'
