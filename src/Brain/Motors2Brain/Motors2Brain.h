...
public: // explicitly make everything available (MABE design philosophy)
  ...
  fmat theta;
	static const int NEURAL_GROWTH_PERIOD {60'000}; // (60,000)
  ...
  static const inline int FRQ_NETWORK_UPDATES {10}, // fA: frequency of network updates(every 10 milliseconds)
			                  FRQ_NEURAL_ADAPTATION {5'000}, // 5'000 // fC: frequency of neural adaptation (every 5 seconds)
			             FRQ_HOMEOSTATIC_PLASTICITY {60'000}, // 60'000 //fD: frequency of homeostatic plasticity (every minute)
